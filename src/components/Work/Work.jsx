...
const Work = () => {
  ...
  return (
    <section
      id="work"
      className="py-24 pb-24 px-[6vw] md:px-[4vw] lg:px-[8vw] font-sans relative"
    >
      {/* Section Title */}
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 p-4">
          <div className="bg-gray-900 rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden relative">
            {" "}
            ...
            <div className="flex flex-col items-start px-6 pb-6">
              ...
              <div className="w-full flex justify-center mb-4">
                <img
                  ...
                  className="w-[90%] h-auto object-contain rounded-xl shadow-2xl"
                />
              </div>
              ...
              <div className="flex gap-4 w-full">
                <a
                  ...
                  className="flex-1 bg-gray-800 hover:bg-purple-800 text-gray-300 py-2 rounded-xl text-center text-sm font-semibold"
                >
                  View Code
                </a>
                <a
